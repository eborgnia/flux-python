...
def _get_open_connections(client: Flux | AsyncFlux) -> int:
...
class TestFlux:
    client = Flux(base_url=base_url, _strict_response_validation=True)
    ...
    def test_copy_default_headers(self) -> None:
        client = Flux(base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"})
    ...
    def test_copy_default_query(self) -> None:
        client = Flux(base_url=base_url, _strict_response_validation=True, default_query={"foo": "bar"})
    ...
    def test_client_timeout_option(self) -> None:
        client = Flux(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_http_client_timeout_option(self) -> None:
        ...
        with httpx.Client(timeout=None) as http_client:
            client = Flux(base_url=base_url, _strict_response_validation=True, http_client=http_client)
    ...
    async def test_invalid_http_client(self) -> None:
        with pytest.raises(TypeError, match="Invalid `http_client` arg"):
            async with httpx.AsyncClient() as http_client:
                Flux(base_url=base_url, _strict_response_validation=True, http_client=cast(Any, http_client))
    ...
    def test_default_query_option(self) -> None:
        client = Flux(base_url=base_url, _strict_response_validation=True, default_query={"query_param": "bar"})
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        url = httpx.URL(request.url)
    ...
    def test_multipart_repeating_array(self, client: Flux) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Flux(base_url="https://example.com/from_init", _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(FLUX_BASE_URL="http://localhost:5000/from/env"):
            client = Flux(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Flux(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            Flux(
    ...
    def test_base_url_trailing_slash(self, client: Flux) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Flux) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Flux) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Flux(base_url=base_url, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Flux(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Flux(base_url=base_url, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                "/classify",
                body=cast(object, dict(input="string", labels=["string", "string", "string"])),
    ...
    def test_retries_taken(self, client: Flux, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        response = client.with_raw_response.classify(input="string", labels=["string", "string", "string"])

        assert response.retries_taken == failures_before_success


class TestAsyncFlux:
    client = AsyncFlux(base_url=base_url, _strict_response_validation=True)
    ...
    def test_copy_default_headers(self) -> None:
        client = AsyncFlux(base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"})
        assert client.default_headers["X-Foo"] == "bar"
    ...
    def test_copy_default_query(self) -> None:
        client = AsyncFlux(base_url=base_url, _strict_response_validation=True, default_query={"foo": "bar"})
        assert _get_params(client)["foo"] == "bar"
    ...
    async def test_client_timeout_option(self) -> None:
        client = AsyncFlux(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    async def test_http_client_timeout_option(self) -> None:
        ...
        async with httpx.AsyncClient(timeout=None) as http_client:
            client = AsyncFlux(base_url=base_url, _strict_response_validation=True, http_client=http_client)
    ...
    def test_invalid_http_client(self) -> None:
        with pytest.raises(TypeError, match="Invalid `http_client` arg"):
            with httpx.Client() as http_client:
                AsyncFlux(base_url=base_url, _strict_response_validation=True, http_client=cast(Any, http_client))
    ...
    def test_default_query_option(self) -> None:
        client = AsyncFlux(base_url=base_url, _strict_response_validation=True, default_query={"query_param": "bar"})
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        url = httpx.URL(request.url)
        assert dict(url.params) == {"query_param": "bar"}
    ...
    def test_multipart_repeating_array(self, async_client: AsyncFlux) -> None:
    ...
    def test_base_url_setter(self) -> None:
        client = AsyncFlux(base_url="https://example.com/from_init", _strict_response_validation=True)
        assert client.base_url == "https://example.com/from_init/"
    ...
    def test_base_url_env(self) -> None:
        with update_env(FLUX_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncFlux(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            AsyncFlux(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            AsyncFlux(
                base_url="http://localhost:5000/custom/path/",
                _strict_response_validation=True,
    ...
    def test_base_url_trailing_slash(self, client: AsyncFlux) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncFlux) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncFlux) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            AsyncFlux(base_url=base_url, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncFlux(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncFlux(base_url=base_url, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self, async_client: AsyncFlux, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        ...
        response = await client.with_raw_response.classify(input="string", labels=["string", "string", "string"])
