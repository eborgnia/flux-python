...
from .types import top_level_classify_params
from ._types import (
    NOT_GIVEN,
    Body,
    Omit,
...
class Flux(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous flux client instance."""
        if base_url is None:
        ...
        *,
        ...
        return self.post(
            ...
            body=maybe_transform(
                ...
                top_level_classify_params.TopLevelClassifyParams,
            ),
...
class AsyncFlux(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async flux client instance."""
        if base_url is None:
            base_url = os.environ.get("FLUX_BASE_URL")
        if base_url is None:
            base_url = f"https://api.itsflux.com"
